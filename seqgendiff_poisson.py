...
def generate_poisson_dataset(input_csv, output_csv, noise_std, hasControl, gene_up, gene_down, gene_n):
    ...
    # b = np.random.normal(0, 1, p)  # Generate gene effects
    ...
    log_scaled_new_Theta = np.log1p(new_Theta)
    log_scaled_new_tilde_Theta = np.log1p(new_tilde_Theta)
...
output_csv = '/Users/zhangch/Downloads/generated_GSE212277_merged.counts.bulk.csv'
# Define gene effect lists
gene_up = ['Gnai3', 'Narf', 'Cav2']
gene_down = ['Klf6', 'Scmh1', 'Cox5a']
gene_no = ['Fer', 'Xpo6', 'Axin2']
generate_poisson_dataset(input_csv, output_csv, 1, True, gene_up, gene_down, gene_no)
